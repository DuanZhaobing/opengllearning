...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // not: currently we set the projection matrix each frame, but since the projection matrix rarely changes it's
        // often best pratice to set it outside the main loop only once.
